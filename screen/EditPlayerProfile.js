...
//     const [playerSport, setPlayerSport] = useState(games.find((item) => item.id === player.game_id));
//     const [mediaUrl, setMediaUrl] = useState(player.mediaUrl);
//     const [position, setPosition] = useState(player.positions);
//     const [playerCountry, setPlayerCountry] = useState(player.country);
...
//     console.log("Player Sport: ", playerSport);
...
//                     <Text style={tailwind`text-lg p-2`}>Update Player</Text>
